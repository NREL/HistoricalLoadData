...
profile_type=""
impute_file_path = paste0(sprintf("data/%s/csv_MASTER.csv", profile_type))
...
dir.create(sprintf('data/%s/MICE_output', profile_type), recursive = TRUE)

pdf(file = paste0(sprintf('data/%s/MICE_output/convergence_check_impute_csv_MASTER.pdf', profile_type)), width = 10, height = 10)
print(
...
write.csv(x = mice_lag_embed_imputations_summarized_wide,
          file = sprintf('data/%s/MICE_output/mean_impute_csv_MASTER.csv', profile_type))
...
write.csv(x = mice_lag_embed_imputations_all_wide,
          file = sprintf('data/%s/MICE_output/all_impute_csv_MASTER.csv', profile_type))
